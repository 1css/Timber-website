...
function SellersClass() {
  ...
  const handleChangeConnect = (id) => {
    ...
    navigate(`/admin/sellerdetail?uid=${encodedId}`);
  };
    ...
    <div>
      ...
      <Container>
        <Box display="flex" mb={2} flexWrap="wrap">
          ...
          <Button
            onClick={() => navigate("/admin/sellerdetail")}
            style={{
              backgroundColor: "blue",
              color: colors.grey[100],
              marginLeft: "10px",
          ...
          <Button
            onClick={() => navigate("/admin/addseller")}
            style={{
              backgroundColor: "blue",
              color: colors.grey[100],
              marginLeft: "10px",
        ...
        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          <Grid xs={12} sm={12} md={6} lg={3} xl={3}>
            <Link to="/admin/sellerslist" style={{ textDecoration: "none" }}>
              <Box
                width="100%"
